...
import (
	...
	"gfEasy/app/service/BaseSysMenuService"
...
// @Success 1000 {object} response.Response "{"code": 1000, "data": [...]}"
// @Router /api/baseSysMenu/update [post]
// @Security
...
// @Success 1000 {object} response.Response "{"code": 1000, "data": [...]}"
// @Router /api/baseSysMenu/delete [post]
// @Security
...
// @Success 1000 {object} response.Response "{"code": 1000, "data": [...]}"
// @Router /api/baseSysMenu/info [get]
// @Security
...
// @Success 1000 {object} response.Response "{"code": 1000, "data": [...]}"
// @Router /api/baseSysMenu/list [get]
// @Security
...
// @Success 1000 {object} response.Response "{"code": 1000, "data": [...]}"
// @Router /api/baseSysMenu/page [get]
// @Security
