...
import (
	...
	"gfEasy/app/service/BaseSysDepartmentService"
...
// @Success 1000 {object} response.Response "{"code": 1000, "data": [...]}"
// @Router /api/baseSysDepartment/update [post]
// @Security
...
// @Success 1000 {object} response.Response "{"code": 1000, "data": [...]}"
// @Router /api/baseSysDepartment/delete [post]
// @Security
...
// @Success 1000 {object} response.Response "{"code": 1000, "data": [...]}"
// @Router /api/baseSysDepartment/info [get]
// @Security
...
// @Success 1000 {object} response.Response "{"code": 1000, "data": [...]}"
// @Router /api/baseSysDepartment/list [get]
// @Security
...
// @Success 1000 {object} response.Response "{"code": 1000, "data": [...]}"
// @Router /api/baseSysDepartment/page [get]
// @Security
