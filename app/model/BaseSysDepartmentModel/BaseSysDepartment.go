...
// 生成人：JasonLaw
// ==========================================================================
package BaseSysDepartmentModel
...
// Entity is the golang structure for table baseSysDepartment.
type Entity struct {
	...
	ParentId   int64       `orm:"parentId" json:"parentId"`     // 上级部门ID
	OrderNum   int         `orm:"orderNum" json:"orderNum"`     // 排序
}

var (
	// Table is the table name of baseSysDepartment.
