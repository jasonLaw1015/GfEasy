...
// Entity is the golang structure for table baseSysRoleMenu.
type Entity struct {
	...
	MenuId     int64       `orm:"menuId" json:"menuId"`         // 菜单ID
}

var (
	// Table is the table name of baseSysRoleMenu.
